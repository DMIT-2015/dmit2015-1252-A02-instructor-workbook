...
//                .addAsLibraries(pomFile.resolve("com.microsoft.sqlserver:mssql-jdbc:13.2.1.jre11").withTransitivity().asFile())
//                .addAsLibraries(pomFile.resolve("com.oracle.database.jdbc:ojdbc11:23.26.0.0.0").withTransitivity().asFile())
//                .addAsLibraries(pomFile.resolve("org.hibernate.orm:hibernate-spatial:6.6.42.Final").withTransitivity().asFile())
                .addAsLibraries(pomFile.resolve("org.postgresql:postgresql:42.7.8").withTransitivity().asFile())
    ...
    void shouldUpdate() throws SystemException, NotSupportedException {
        ...
        existingMovie.setTitle("JDK 21 Release Party");
        existingMovie.setRating("PG-13");
        existingMovie.setPrice(BigDecimal.valueOf(19.99));
        existingMovie.setReleaseDate(LocalDate.parse("2023-09-19"));
