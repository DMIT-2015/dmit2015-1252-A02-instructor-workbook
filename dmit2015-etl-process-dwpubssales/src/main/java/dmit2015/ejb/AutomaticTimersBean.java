	...
	private void sendEmail(Timer timer) {
	 ...
	 @Schedules({
	 	@Schedule(second = "0", minute ="50", hour = "7",
				...
				month = "Jan-Apr",
				year = "2026",
				info ="DMIT2015-A02 in WA322", persistent = false),
			 @Schedule(second = "0", minute ="48,50,52", hour = "13",
					 dayOfWeek = "Tue",
					 month = "Jan-Apr",
					 year = "2026",
					 info ="DMIT2015-A02 in WC322", persistent = false),
			 @Schedule(second = "0", minute ="50", hour = "9",
					 dayOfWeek = "Fri",
					 month = "Jan-Apr",
					 year = "2026",
					 info ="DMIT2015-A02 Teams Meeting", persistent = false),
	 })
	public void dmit2015SectionA01ClassNotification(Timer timer) {
		sendEmail(timer);
	}
