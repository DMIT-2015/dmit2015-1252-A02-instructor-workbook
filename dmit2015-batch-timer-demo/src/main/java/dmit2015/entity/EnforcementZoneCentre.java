...
/**
 * https://data.edmonton.ca/Transportation/All-Photo-Enforcement-Zone-Centre-Points/epqc-y5cq/about_data
 *
...
public class EnforcementZoneCentre implements Serializable {
    ...
    public static Optional<EnforcementZoneCentre> parseCsv(String line) {
		...
		try {
			...
			model.setLatitude(Double.parseDouble(values[4]));
			model.setLongitude(Double.parseDouble(values[5]));

			String wktText = values[7];
